...
const representationInstanceModelReducer = (
  ...
  switch (action.type) {
    ...
    case UPDATE_REPRESENTATION_INSTANCE_CLASS:
    ...
    case UPDATE_REPRESENTATION_INSTANCE_ATTRIBUTE:
    ...
    case UPDATE_REPRESENTATION_INSTANCE_OPERATION:
    ...
    case UPDATE_REPRESENTATION_INSTANCE_REFERENCE:
